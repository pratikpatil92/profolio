            ...
            <section id="contact">
                ...
                <div className="contatct-info-upper-container">
                    <div className="contact-info-container">
                        <Image src="/img/email.png" width="40" height="40" className="icon contact-icon email-icon" />
                        <p><a href="mailto:pratikpatil062@gmail.com">pratikpatil062@gmail.com</a></p>
                    </div>
                    <div className="contact-info-container">
                        <Image src="/img/linkedin.png" width="40" height="40" className="icon contact-icon" />
